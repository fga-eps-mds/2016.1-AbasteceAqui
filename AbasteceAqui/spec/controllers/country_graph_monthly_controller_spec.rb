...
RSpec.describe CountryGraphMonthlyController, type: :controller do
	...
	describe "#calculate_average_of_fuel comparing array size" do
		it "shold return gasoline separeted by month" do
			...
			fuels = controller.find_fuels_of_research_of_year(all_researches_selected_year)
			fuels_month = controller.find_fuels_by_type(fuels)
			average_gasoline = controller.calculate_average_of_fuel(fuels_month, fuel_name)
	...
	describe "#calculate_average_of_fuel comparing average" do
		it "shold return ethanol separeted by month" do
			...
			fuels = controller.find_fuels_of_research_of_year(all_researches_selected_year)
			fuels_month = controller.find_fuels_by_type(fuels)
			average_ethanol = controller.calculate_average_of_fuel(fuels_month, fuel_name)
	...
	describe "#calculate_average_of_fuel comparing array size" do
		it "shold return diesel separeted by month" do
			...
			fuels = controller.find_fuels_of_research_of_year(all_researches_selected_year)
			fuels_month = controller.find_fuels_by_type(fuels)
			average_diesel = controller.calculate_average_of_fuel(fuels_month, fuel_name)
